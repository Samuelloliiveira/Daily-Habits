...
export function NewHabitForm() {
  ...
  const [aletSuccess, setAletSuccess] = useState('')
  ...
  async function createNewHabit(event: FormEvent) {
    ...
    setAletSuccess("Hábito criado com sucesso!")
  }
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        ...
        className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-500"
        autoFocus
        value={title}
